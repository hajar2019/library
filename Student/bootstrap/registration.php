  ...
  <div class="reg_img">
    ...
    <div class="box2">
      ...
      <form name="Registration" action="" method="post">
        ...
        <div class="login">
          ...
          <input class="form-control" type="text" name="Donate" placeholder="Donate" required=""><br>
    ...
    <?php
      ...
      if(isset($_POST['submit']))
      {
        ...
        if($count==0)
        {
          mysqli_query($db,"INSERT INTO `STUDENT` VALUES('$_POST[first]', '$_POST[last]', '$_POST[username]', '$_POST[password]', '$_POST[roll]', '$_POST[email]', '$_POST[donate] ,'$_POST[contact]', 'p.jpg');");
        ?>
